            ...
            $(document).ready(function () {
                let datatable = $('#inspectionsTable').DataTable({
                    ...
                    "columns": [
                        ...
                        { defaultContent: `
                            <div class="flex">    
                                <a href="/#" class="text-gray-800 hover:text-gray-600 focus:ring-2 focus:outline-none focus:ring-gray-300 font-light rounded-lg text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900">
