<x-app-layout>
    ...
    <div class="py-12 flex items-center">
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border-red-500 border-2 dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('inspection.destroy', [$inspection->id]) }}" method="POST">
                        @method('DELETE')
                        @csrf
                        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                            ¿Confirma que desea eliminar la Inspección?
                        </h2>
                            <div class="pt-3 pb-4 px-3 mt-4 flex flex-col flex-wrap sm:flex-nowrap sm:flex-row sm:gap-4 border rounded border-gray-400">    
                                <div>
                                    <div class="pb-1 flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">
                                ...
                                <div>
                                    ...
                                    <div data-modal-target="defaultModal" data-modal-toggle="defaultModal" class="underline underline-offset-8 decoration-violet-500 decoration-wavy pb-1 flex items-center text-gray-500 dark:text-gray-400 hover:text-blue-600 dark:hover:text-blue-500 group">
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                            ...
                            <div class="flex justify-around mt-10 gap-4">
                                <button type="submit" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Eliminar</button>
