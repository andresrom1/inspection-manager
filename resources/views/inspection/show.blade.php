                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                        ...
                        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                            ...
                            <div class="flex justify-around mt-10 gap-4">
                                ...
                                <a href="{{ route('inspection.edit', $inspection) }}" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Editar</a>
                            </div>
                </div>
            </div>
        </div>
