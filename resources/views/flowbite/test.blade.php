    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <h1>Probar el dropdown a ver si funciona correctamente</h1>    
                ...
                <button data-modal-target="delete-modal" data-modal-toggle="delete-modal" class="block text-gray-800 hover:text-gray-600 focus:ring-2 focus:outline-none focus:ring-gray-300 font-light rounded-lg text-sm p-1 text-center inline-flex items-center mr-2 dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-900" type="button">
