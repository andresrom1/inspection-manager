    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 text-center">
                ...
                <h3 class="mb-2 text-lg font-normal text-gray-500 dark:text-gray-400">Estás seguro que deseas eliminar a</h3>
                <h3 class="mb-5 text-lg font-normal text-gray-700 dark:text-gray-300">{{ $taker->name }}</h3>
                <div class="flex justify-center">
                    <form method="POST" action="/takers/{{ $taker->id }}">
                        @csrf
                        @method('delete')
