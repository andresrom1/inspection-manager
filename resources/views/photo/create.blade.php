    ...
    <div class="flex items-center justify-center w-60 h-60 mt-5">
        <label for="camera-front" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                <x-inspections.front></x-inspections.front>  
                <div class="border-2 px-2 py-2 bg-gray-50 rounded-xl mt-5 flex items-center">
                    ...
                    <p class="ml-2 text-sm text-gray-500 dark:text-gray-400">Subir foto: <span class="font-bold">Frente</span></p>
                </div>
                
            </div>
            <input id="camera-front" type="file" class="hidden" capture/>
        </label>
    </div>
        ...
        <label for="camera-front" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <div class="border-2 px-2 py-2 bg-gray-50 rounded-xl mt-5 flex items-center">
                    ...
                    <p class="ml-2 text-sm text-gray-500 dark:text-gray-400">Subir foto: <span class="font-bold">Lateral Izquierdo</span></p>
                </div>
        ...
        <label for="camera-front" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <div class="border-2 px-2 py-2 bg-gray-50 rounded-xl mt-5 flex items-center">
                    ...
                    <p class="ml-2 text-sm text-gray-500 dark:text-gray-400">Subir foto: <span class="font-bold">Atrás</span></p>
                </div>
        ...
        <label for="camera-front" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-white dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                ...
                <div class="border-2 px-2 py-2 bg-gray-50 rounded-xl mt-5 flex items-center">
                    ...
                    <p class="ml-2 text-sm text-gray-500 dark:text-gray-400">Subir foto: <span class="font-bold">Lateral Derecho</span></p>
                </div>
