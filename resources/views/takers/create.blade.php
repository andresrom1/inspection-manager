    ...
    <div class="py-12 flex items-center">
        <div class="mx-auto sm:px-6 lg:px-8">
            <div class="bg-white border-gray-300 border-2 dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <h2 class="mb-4 text-xl font-bold text-gray-900 dark:text-white">Crear un nuevo Tomador 💎</h2>
                <form action="/takers" method="post">
                    @csrf
                    <div class="grid grid-cols-1 gap-3">
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            <div class="mb-6">
                                ...
                                <input value="{{ old('email') }}" name="email" type="email" id="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="nombre@mail.com" required>
                        ...
                        <div class="grid grid-cols-2 gap-5">
                            ...
                            <div class="mb-6">
                                ...
                                <input value="{{ old('id_number') }}" name="id_number" type="number" id="id_number" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="30-66728231-9" required>
                    ...
                    <button type="submit" class="mt-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Crear Tomador</button>
                </form>
                </div>
            </div>
        </div>
